...
const scheduleByClass: Record<string, ClassSchedule> = {
  "7a": {
    Dushanba: { "09:00": { subject: "Python asoslari", teacher: "Kamolov A." }, "14:00": { subject: "Web dasturlash", teacher: "Rahimova M." } },
  ...
  "7b": {
    Dushanba: { "10:00": { subject: "Scratch", teacher: "Nurmatov B." }, "15:00": { subject: "Algoritmlar", teacher: "Toshmatov J." } },
    Seshanba: { "09:00": { subject: "Python asoslari", teacher: "Kamolov A." } },
    Chorshanba: { "14:00": { subject: "Kompyuter savodxonligi", teacher: "Nurmatov B." } },
    Payshanba: { "10:00": { subject: "Scratch (amaliy)", teacher: "Nurmatov B." } },
    Juma: { "11:00": { subject: "Algoritmlar", teacher: "Toshmatov J." } },
  },
  "8a": {
    Dushanba: { "11:00": { subject: "Algoritmlar", teacher: "Toshmatov J." } },
    Seshanba: { "14:00": { subject: "Ma'lumotlar bazasi", teacher: "Kamolov A." } },
    Chorshanba: { "15:00": { subject: "JavaScript", teacher: "Toshmatov J." } },
    Payshanba: { "10:00": { subject: "Algoritmlar", teacher: "Toshmatov J." }, "16:00": { subject: "Tarmoqlar", teacher: "Nurmatov B." } },
    Juma: { "11:00": { subject: "Loyiha ishi", teacher: "Rahimova M." } },
  },
  "8b": {
    Dushanba: { "09:00": { subject: "C++ asoslari", teacher: "Toshmatov J." } },
    Seshanba: { "11:00": { subject: "Python (amaliy)", teacher: "Kamolov A." }, "15:00": { subject: "Tarmoqlar", teacher: "Nurmatov B." } },
    Chorshanba: { "10:00": { subject: "Ma'lumotlar bazasi", teacher: "Kamolov A." } },
    Payshanba: { "14:00": { subject: "C++ (amaliy)", teacher: "Toshmatov J." } },
    Juma: { "09:00": { subject: "Test", teacher: "Kamolov A." } },
  },
  "9a": {
    Dushanba: { "14:00": { subject: "Python (ilg'or)", teacher: "Kamolov A." } },
    Seshanba: { "09:00": { subject: "Web dasturlash", teacher: "Rahimova M." }, "14:00": { subject: "Algoritmlar", teacher: "Toshmatov J." } },
    Chorshanba: { "11:00": { subject: "Loyiha ishi", teacher: "Rahimova M." } },
    Payshanba: { "09:00": { subject: "Kiberhavfsizlik", teacher: "Nurmatov B." } },
    Juma: { "14:00": { subject: "Python (amaliy)", teacher: "Kamolov A." } },
  },
  "9b": {
    Dushanba: { "10:00": { subject: "JavaScript", teacher: "Toshmatov J." } },
    Seshanba: { "15:00": { subject: "Web dasturlash", teacher: "Rahimova M." } },
    Chorshanba: { "09:00": { subject: "Algoritmlar", teacher: "Toshmatov J." }, "14:00": { subject: "Loyiha ishi", teacher: "Rahimova M." } },
    Payshanba: { "11:00": { subject: "Python (ilg'or)", teacher: "Kamolov A." } },
    Juma: { "10:00": { subject: "Kiberhavfsizlik", teacher: "Nurmatov B." }, "15:00": { subject: "Test", teacher: "Toshmatov J." } },
  },
};
          ...
          {classes.map((cls) => (
            ...
            >
              ...
              <span className={`text-xs px-1.5 py-0.5 rounded-full ${
                activeClass === cls.id ? "bg-primary-foreground/20" : "bg-secondary"
              }`}>
                {cls.students}
              </span>
            </button>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b bg-secondary/50">
                  ...
                  {days.map((day) => (
                    <th key={day} className="px-4 py-3 text-left font-medium text-muted-foreground min-w-[140px]">
                      {day}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {timeSlots.map((time) => (
                  <tr key={time} className="border-b last:border-0">
                    <td className="px-4 py-3 text-xs font-medium text-muted-foreground tabular-nums">{time}</td>
                    {days.map((day) => {
                        ...
                        <td key={day} className="px-4 py-2">
                          {lesson ? (
                            <div className="bg-primary/8 border border-primary/15 rounded-lg p-2.5 hover:bg-primary/12 transition-colors">
                              ...
                              <p className="text-[11px] text-muted-foreground mt-0.5">{lesson.teacher}</p>
                            </div>
                          ) : null}
                        </td>
                      );
